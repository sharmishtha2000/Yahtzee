...
const twos = new TotalOneNumber({ val: 2, description: "1 point per 2" });
const threes = new TotalOneNumber({ val: 3, description: "1 point per 3" });
const fours = new TotalOneNumber({ val: 4, description: "1 point per 4" });
const fives = new TotalOneNumber({ val: 5, description: "1 point per 5" });
const sixes = new TotalOneNumber({ val: 6, description: "1 point per 6" });
